...
public class RedisCacheUtils {
    @Autowired
    private  StringRedisTemplate stringRedisTmp;
    @Autowired
    ...
    @PostConstruct
    private void init(){
        RedisCacheUtils.redisTemplates = redisTemplate;
        RedisCacheUtils.stringRedisTemplate = stringRedisTmp;
    }
    ...
    public static void batchDel(String... pattern){
        for (String kp : pattern) {
            redisTemplates.delete(redisTemplates.keys(kp + "*"));
        }
    }
    ...
    public static Object getObj(String key){
        return redisTemplates.boundValueOps(key).get();
    }
    ...
    public static Object getObj(String key, boolean retain){
        Object obj = redisTemplates.boundValueOps(key).get();
        if(!retain){
            redisTemplates.delete(key);
        }
        return obj;
    ...
    public static <T> T get(String key, Class<T> clazz) {
        return (T) redisTemplates.boundValueOps(key).get();
    }
    ...
    public static double decr(String key, double by){
        return redisTemplates.opsForValue().increment(key, -by);
    }
    ...
    public static void addMap(String key, String field, String value){
        redisTemplates.opsForHash().put(key, field, value);
    }
    ...
    public static <T> void addMap(String key, String field, T obj){
        redisTemplates.opsForHash().put(key, field, obj);
    }
    ...
    public static <T> Map<String, T> mget(String key, Class<T> clazz){
        BoundHashOperations<String, String, T> boundHashOperations = redisTemplates.boundHashOps(key);
    ...
    public static <T> T getMap(String key, Class<T> clazz){
        BoundHashOperations<String, String, String> boundHashOperations = redisTemplates.boundHashOps(key);
    ...
    public static <T> T getMapField(String key, String field, Class<T> clazz){
        return (T) redisTemplates.boundHashOps(key).get(field);
    }
    ...
    public void delMapField(String key, String... field){
        BoundHashOperations<String, String, ?> boundHashOperations = redisTemplates.boundHashOps(key);
    ...
    public static void sadd(String key, String... value) {
        redisTemplates.boundSetOps(key).add(value);
    }
    ...
    public static void srem(String key, String... value) {
        redisTemplates.boundSetOps(key).remove(value);
    }
    ...
    public static void srename(String oldkey, String newkey){
        redisTemplates.boundSetOps(oldkey).rename(newkey);
    }
    ...
    public static Set<String> keys(String pattern){
        return redisTemplates.keys(pattern);
    }

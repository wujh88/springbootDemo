...
public class ValidationPicUtils {
	...
	// 用工厂方法创建对象
	protected ValidationPicUtils(int charCount) {
	...
	public static ValidationPicUtils createInstance(int charCount) throws Exception {
		if (charCount < 1 || charCount > MAX_CHARCOUNT) {
			throw new Exception(
					"Invalid parameter charCount,charCount should between in 1 and 16");

		}
		return new ValidationPicUtils(charCount);
	}
	...
	public String drawInputstr(int num, String graphicFormat, OutputStream out)
			throws IOException {
	 ...
	 * @throws Exception
	 */
	public static Map<String,String> getVerificationCode() throws Exception {
		Map<String,String> returnMap=new HashMap<String, String>();
		ByteArrayOutputStream output = new ByteArrayOutputStream();
		String str="";
		try {
			str = ValidationPicUtils.createInstance(4).drawInputstr(4,
					ValidationPicUtils.GRAPHIC_PNG, output);
			byte[] captcha = output.toByteArray();
			BASE64Encoder encoder = new BASE64Encoder();
			String imagestr = encoder.encode(captcha);
			returnMap.put("validationCode", str);
			returnMap.put("imagestr", imagestr);
			output.close();
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			throw new ServiceException("获取验证码图片失败");
		}finally{
			if(output!=null){
				output.close();
			}
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		ByteArrayOutputStream output = new ByteArrayOutputStream();
		String str = ValidationPicUtils.createInstance(4).drawInputstr(4,
				ValidationPicUtils.GRAPHIC_PNG, output);
		...
		//
		// System.out.println(RandomGraphic.createInstance(4).drawAlpha(RandomGraphic.GRAPHIC_JPEG,new
		// FileOutputStream("D:/myimg2.png")));

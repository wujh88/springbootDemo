...
//                          System.out.println(val);
        ...
        try {
       	 String filepath="D://优惠券/"+getdeliveryNo()+".xls";
            //默认导出到E盘下
	...
	private String getdeliveryNo(){
		int no=(int)RedisCacheUtils.incr("deliveryNo", 1);
		return DateUtil.getDateFormat(new Date()).replaceAll("-", "")+ "优惠券"+ StringUtils.leftPad(String.valueOf(no), 7,"0");
	}
